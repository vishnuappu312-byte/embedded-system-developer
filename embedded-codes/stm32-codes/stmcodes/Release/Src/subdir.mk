...
clean-Src:
	-$(RM) ./Src/led_blink.cyclo ./Src/led_blink.d ./Src/led_blink.o ./Src/led_blink.su ./Src/main.cyclo ./Src/main.d ./Src/main.o ./Src/main.su ./Src/syscalls.cyclo ./Src/syscalls.d ./Src/syscalls.o ./Src/syscalls.su ./Src/sysmem.cyclo ./Src/sysmem.d ./Src/sysmem.o ./Src/sysmem.su
